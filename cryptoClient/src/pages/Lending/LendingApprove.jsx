  ...
  useEffect(() => {
    const fetchLoans = async () => {
      const res = await axios.get(
        `http://localhost:5000/loan/userapproved/${user.userEmail}`
      );
      console.log(res.data.approvedList);
      setLoans(res.data.approvedList);
    };
    fetchLoans();
  }, []);
        ...
        <div className=" pl-[10%] pr-[10%] pt-[3%] text-white rounded-2xl shadow-lg w-full m-[5%] relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col items-center mb-6">
              <h1 className="text-2xl font-bold">Approved Loans List</h1>
              <p className="text-gray-400">
                Make your repayment easily and securely
              </p>
            </div>


            {/* Scrollable Loan List */}
            <div className="max-h-[600px] mt-16 overflow-y-auto space-y-4 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-900 pr-2">
              {loans.map((loan, index) => (
                ...
                >
                  ...
                  <button
                    onClick={() => navigate("/lendingStatus", { state: loan })}

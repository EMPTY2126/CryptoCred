  ...
  const [amount, setAmount] = useState("");
    ...
    const numberInput = (event) => {
      ...
      const depositAmount = async()=>{
        let payload = {userId : user.userEmail, amount};
        await axios.post('http://localhost:5000/payment/withdraw',payload)
        await historyMaker(generateRandomString(), "Self", currDate(), `An amount of ${amount} withdrawed to your account`, amount, "PhonePe", "Withdraw", user.userEmail);
       navigate(-1);
      }
